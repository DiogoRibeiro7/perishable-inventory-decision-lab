...
| Release gate | `poetry run python scripts/release_gate.py --write reports/release/v0.1.0_gate.json` | Pass |
...
- Cards match package version `0.1.0`.
...
| Stockout-censored demand handling is included but needs retailer validation. | Covered by tests and listed as a deployment risk. |
