...
The roadmap is derived from the repository's existing evidence, readiness, architecture, and operations documents. This table makes that dependency explicit so future changes can update both the roadmap and the source documents together.

| Version | Source documents | Existing gaps addressed | Release decision |
|---|---|---|---|
| `0.2.0` | [`docs/READINESS_REVIEW.md`](docs/READINESS_REVIEW.md), [`docs/LATENT_DEMAND_CARD.md`](docs/LATENT_DEMAND_CARD.md), [`docs/INVENTORY_BELIEF.md`](docs/INVENTORY_BELIEF.md), [`docs/TRACEABILITY_MATRIX.md`](docs/TRACEABILITY_MATRIX.md), [`docs/PUBLIC_RETAIL_DATASET_CARD.md`](docs/PUBLIC_RETAIL_DATASET_CARD.md) | Sales are treated as demand under stockouts; hidden inventory state is acknowledged but not part of the canonical demand contract; public data assumptions need explicit treatment. | Block live recommendation publication until censored-demand indicators and metrics are visible. |
| `0.3.0` | [`docs/READINESS_REVIEW.md`](docs/READINESS_REVIEW.md), [`docs/FEATURE_STORE_LINEAGE.md`](docs/FEATURE_STORE_LINEAGE.md), [`docs/MODEL_CARD.md`](docs/MODEL_CARD.md), [`docs/HIERARCHICAL_FORECASTING.md`](docs/HIERARCHICAL_FORECASTING.md), [`docs/TEST_STRATEGY.md`](docs/TEST_STRATEGY.md) | Store and product encodings can shift between training and scoring; conformal calibration is global only; fallback forecasts are documented but not fully tied to scoring parity. | Block model promotion until feature metadata, category vocabularies, and segment calibration diagnostics are stable. |
| `0.4.0` | [`docs/READINESS_REVIEW.md`](docs/READINESS_REVIEW.md), [`docs/MODELLING_DECISIONS.md`](docs/MODELLING_DECISIONS.md), [`docs/SIMULATOR_CARD.md`](docs/SIMULATOR_CARD.md), [`docs/POLICY_CARD.md`](docs/POLICY_CARD.md), [`docs/INVENTORY_OPTIMIZATION.md`](docs/INVENTORY_OPTIMIZATION.md), [`docs/FORECAST_DECISION_CONTRACT.md`](docs/FORECAST_DECISION_CONTRACT.md) | Simulator event order is fixed; policy comparison can prefer aggregate cost while harming a segment; forecast-to-order assumptions need explicit constraint reporting. | Block automatic policy selection until event order and service-floor constraints are testable and reported. |
| `0.5.0` | [`docs/PUBLIC_RETAIL_DATASET_CARD.md`](docs/PUBLIC_RETAIL_DATASET_CARD.md), [`docs/CASE_STUDY.md`](docs/CASE_STUDY.md), [`docs/CLAIMS_AUDIT.md`](docs/CLAIMS_AUDIT.md), [`docs/PORTFOLIO_CASE_STUDY.md`](docs/PORTFOLIO_CASE_STUDY.md), [`docs/RELEASE_NOTES.md`](docs/RELEASE_NOTES.md) | Synthetic examples are reproducible but do not exercise a public benchmark; public data licensing and unavailable operational fields need clearer separation from synthetic outputs. | Allow public benchmark reporting only when raw data remains external and assumptions are documented. |
| `0.6.0` | [`docs/TRACEABILITY_MATRIX.md`](docs/TRACEABILITY_MATRIX.md), [`gcp/DEPLOYMENT_RUNBOOK.md`](gcp/DEPLOYMENT_RUNBOOK.md), [`docs/IAM_MATRIX.md`](docs/IAM_MATRIX.md), [`docs/SECURITY_GOVERNANCE.md`](docs/SECURITY_GOVERNANCE.md), [`docs/DEPENDENCY_POLICY.md`](docs/DEPENDENCY_POLICY.md) | dbt, Airflow, Cloud Build, and Cloud Run patterns exist but are mostly scaffold evidence; CI does not yet validate warehouse and orchestration examples. | Keep cloud paths optional, but require local validation of warehouse and orchestration examples before calling them release-ready. |
| `0.7.0` | [`docs/PUBLICATION_RUNBOOK.md`](docs/PUBLICATION_RUNBOOK.md), [`docs/OBSERVABILITY_RUNBOOK.md`](docs/OBSERVABILITY_RUNBOOK.md), [`docs/DASHBOARD_FRESHNESS.md`](docs/DASHBOARD_FRESHNESS.md), [`docs/DASHBOARD_METRIC_DICTIONARY.md`](docs/DASHBOARD_METRIC_DICTIONARY.md), [`docs/TEST_STRATEGY.md`](docs/TEST_STRATEGY.md) | Publication helpers and monitoring exist, but manifest schema, freshness checks, alert ownership, and rollback evidence need stronger contracts. | Block batch publication when manifests, freshness, completeness, or rollback checks fail. |
| `0.8.0` | [`docs/OPERATIONS_FEEDBACK_LOOP.md`](docs/OPERATIONS_FEEDBACK_LOOP.md), [`docs/OVERRIDE_REASON_TAXONOMY.md`](docs/OVERRIDE_REASON_TAXONOMY.md), [`docs/ROLLOUT_EXPERIMENTATION.md`](docs/ROLLOUT_EXPERIMENTATION.md), [`docs/STORE_DISCOVERY_GUIDE.md`](docs/STORE_DISCOVERY_GUIDE.md), [`docs/STORE_OBSERVATION_TEMPLATE.md`](docs/STORE_OBSERVATION_TEMPLATE.md) | Store review, overrides, and feedback loops are documented but not represented in reproducible artifacts; shadow evaluation needs clearer stop criteria. | Allow shadow evaluation artifacts only when original recommendations, overrides, and stop criteria remain auditable. |
| `0.9.0` | [`docs/FINAL_RELEASE_AUDIT.md`](docs/FINAL_RELEASE_AUDIT.md), [`docs/CARD_RELEASE_CHECKLIST.md`](docs/CARD_RELEASE_CHECKLIST.md), [`docs/CHANGE_REVIEW_CHECKLIST.md`](docs/CHANGE_REVIEW_CHECKLIST.md), [`docs/WORKFLOW_GUARDRAILS.md`](docs/WORKFLOW_GUARDRAILS.md), [`docs/RELEASE_NOTES.md`](docs/RELEASE_NOTES.md), [`docs/SYSTEM_CARD.md`](docs/SYSTEM_CARD.md) | Public interfaces, schemas, cards, examples, and release notes need a final consistency pass before stability. | Freeze interfaces and block release-candidate tagging until high-severity gaps are closed or explicitly owned. |
| `1.0.0` | [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md), [`docs/ARCHITECTURE_ONE_PAGER.md`](docs/ARCHITECTURE_ONE_PAGER.md), [`docs/SYSTEM_CARD.md`](docs/SYSTEM_CARD.md), [`docs/READINESS_REVIEW.md`](docs/READINESS_REVIEW.md), [`docs/FINAL_RELEASE_AUDIT.md`](docs/FINAL_RELEASE_AUDIT.md), [`CITATION.cff`](CITATION.cff), [`.zenodo.json`](.zenodo.json) | The repository needs a stable API, documented schemas, reproducible examples, verified operational patterns, and aligned citation/release metadata. | Cut `1.0.0` only when the local-first release is technically stable and remaining limitations are explicit. |
